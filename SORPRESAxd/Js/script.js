...
// --- Música de fondo desde GitHub ---
function playBackgroundMusic() {
  const audio = document.getElementById('bg-music');
  if (!audio) return;

  // ✅ Cargar música directamente desde GitHub:
  audio.src = 'https://gohanf14.github.io/HTML/SORPRESAxd/Music/musica.mp3';
